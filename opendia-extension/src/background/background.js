...
// globalThis.__opendiaHandleChatFrame and reads/writes Cebian's Dexie
// sessionStore. OpenDia keeps ONLY the outbound WS `connectionManager.send`
// hook the bridge uses to push chat_appended / chat_deleted server-push
